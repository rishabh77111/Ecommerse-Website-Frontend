...
const RegisterPage = () => {
  return (
    <main className=" h-screen flex justify-center items-center">
        <section className="border border-gray-200 px-5 py-6 rounded-lg min-w-120">
          ...
          <RegisterForm/>
           ...
           <div>
            ...
            <p className="text-center text-[14px]">Already have an Account? 
              <Link href={'/login'}>
                <span className="text-sky-500 font-semibold px-2">Login</span>
              </Link>
            </p>
           </div>
